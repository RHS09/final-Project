...
class VideoProcessor(VideoProcessorBase):
    def __init__(self, net, detect_humans=True, detect_animals=True, detect_vehicles=True):
        self.net = net
        ...
        with col2:
            ...
            if source_type == "Local Webcam (Testing)" and run_camera:
                ...
                webrtc_ctx = webrtc_streamer(
                    ...
                    video_processor_factory=lambda: VideoProcessor(net, detect_humans, detect_animals, detect_vehicles),
